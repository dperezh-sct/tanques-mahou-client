...
export const FormProvider = ({ children }) => {
    ...
    return (
        <FormContext.Provider value={{
            /**LOCAL*/
            nombreEstab, setNombreEstab, fotoLocal, setFotoLocal, nombreEmpresa, setNombreEmpresa,
            ...
            cp, setCP, provincia, setProvincia, telefono, setTelefono, correo, setCorreo,
            /**ESTACIONAMIENTO*/
            zonaCargaDescarga, setZonaCargaDescarga, permisoCargaDescarga, setPermisoCargaDescarga,
            photoCargaDescarga, setPhotoCargaDescarga, accesoManguera, setAccesoManguera,
            obs1Estacionamiento, setObs1Estacionamiento, distancia, setDistancia,
            photoAccesoManguera, setPhotoAccesoManguera, obs2Estacionamiento, setObs2Estacionamiento,
            desnivelCamionTanque, setDesnivelCamionTanque, desnivelTanqueCamion, setDesnivelTanqueCamion,
            /**TANQUES*/
            tanques, setTanques, enfriadores, setEnfriadores, situacion, setSituacion,
            fotoUbicacionTanques, setFotoUbicacionTanques, sistema, setSistema, tipoSistemaTanques,
            setTipoSistemaTanques, alarma, setAlarma, temperatura, setTemperatura, fotoSituacion,
            setFotoSituacion, estructuraTanque, setEstructuraTanque, certificadoTanques, setCertificadoTanques,
            observacionesTanques, setObservacionesTanques, compresores, setCompresores,
            /**DESPACHO */
            modulos, setModulos
        }}>
            {children}
