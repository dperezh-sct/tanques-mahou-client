                                ...
                                >
                                    <div className={classes.rowCenter}>
                                        <IconButton
                                            ...
                                            onClick={(event) => { event.stopPropagation(), handleDelete(compresor) }}
                                        ...
                                        <div className={classes.row}>
                                            ...
                                            >
                                                ...
                                                <Select
                                                    ...
                                                    onChange={(event) => handleChangeModelo(event, compresores.indexOf(compresor))}
                                                    label="Codigo de producto"
                                                >
                                                    {modelosOp.map((item) => (
                                                        <MenuItem
                                                            key={modelosOp.indexOf(item)}
                                                            value={item}
                                                        >
                                                            {item}
                                                        </MenuItem>
