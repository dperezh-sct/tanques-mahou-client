...
const Otros = props => {
    ...
    const { enfriadores, setEnfriadores, situacion, setSituacion,
        ...
        observacionesTanques, setObservacionesTanques, compresores, setCompresores } = useContext(FormContext);
